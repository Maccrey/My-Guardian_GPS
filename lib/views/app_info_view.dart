  ...
  Widget _buildKoreanContent() {
    return Column(
      ...
      children: [
        ...
        _buildInfoRow('앱 이름', 'Watch Over'),
        _buildInfoRow('버전', '1.0.0'),
        _buildInfoRow('출시일', '2025년 5월 25일'),
        _buildInfoRow('개발자', '임석훈'),
        _buildInfoRow('라이선스', 'MIT'),
        const SizedBox(height: 24),
        _buildSectionTitle('앱 소개'),
        _buildParagraph(
          'Watch Over는 정확한 위치 기반 검색을 제공하여 사용자가 필요한 정보를 빠르게 찾을 수 있도록 도와주는 앱입니다. 위치 추적, 위치 공유, 긴급 상황 알림 등의 다양한 기능을 제공합니다.',
        ),
        const SizedBox(height: 24),
